...
let API_PATH_NAVER_CPV = "https://naveropenapi.apigw.ntruss.com/voice/v1/tts"
...
let arrTitle = ["한국어, 여자", "한국어, 남자", "영어, 여자", "영어, 남자"]
let arrSpeaker = ["mijin", "jinho", "clara", "matt", "meimei"]
